 ...
 * @author MINH MAN
 */
public class AssessmentDataToeic {
    final static protected Log LOG = LogFactory.getLog(AssessmentDataToeic.class);
    ...
    private List<PartDataToeic> partsContents;
    ...
    public AssessmentDataToeic() {
        // TODO Auto-generated constructor stub
    }

    public AssessmentDataToeic(List<PartDataToeic> partsContents, double currentScore, double maxScore) {
        this.partsContents = partsContents;
        this.currentScore = currentScore;
        this.maxScore = maxScore;
    }

    public List<PartDataToeic> getPartsContents() {
        return partsContents;
    }

    public void setPartsContents(List<PartDataToeic> partsContents) {
        this.partsContents = partsContents;
    }
