@ECHO OFF
REM SET JAVA_HOME=C:\Program Files\Java\jdk-11.0.16.1
REM SET JAVA_HOME=C:\Program Files\Java\jdk1.8.0_341
REM SET PATH=%JAVA_HOM%\bin;%PATH%
...
REM copy .\config\configuration\bundles\src\bundle\org\sakaiproject\config\bundle\default.sakai.properties %TOMCAT_HOME%\sakai\default.sakai.properties

ECHO Copy default logging.
REM copy .\kernel\kernel-common\src\main\config\log4j2.properties %TOMCAT_HOME%\sakai\
