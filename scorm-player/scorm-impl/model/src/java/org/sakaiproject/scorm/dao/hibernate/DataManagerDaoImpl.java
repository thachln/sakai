...
public class DataManagerDaoImpl extends HibernateDaoSupport implements DataManagerDao {
	...
	public List<IDataManager> find(long contentPackageId, String learnerId, long attemptNumber) {
		...
		buffer.append("from ").append(SCODataManager.class.getName()).append(" where contentPackageId = :contentPackageId and userId = :userId  and attemptNumber = :attemptNumber ");

		return (List<IDataManager>) getHibernateTemplate().findByNamedParam(buffer.toString(), new String[]{"contentPackageId", "userId", "attemptNumber"}, new Object[] { contentPackageId, learnerId, attemptNumber });
	}

	public IDataManager find(long contentPackageId, String learnerId, long attemptNumber, String scoId) {
		StringBuilder buffer = new StringBuilder();

		buffer.append("from ").append(SCODataManager.class.getName()).append(" where contentPackageId = :contentPackageId and userId = :userId and attemptNumber = :attemptNumber and scoId = :scoId");

		List r = getHibernateTemplate().findByNamedParam(buffer.toString(), new String[]{"contentPackageId", "userId", "attemptNumber", "scoId"}, new Object[] { contentPackageId, learnerId, attemptNumber, scoId });
	...
	public List<IDataManager> find(String courseId) {
		List r = getHibernateTemplate().findByNamedParam("from " + SCODataManager.class.getName() + " where courseId = :courseId ", new String[]{"courseId"}, new Object[] { courseId });
	...
	public IDataManager find(String courseId, String scoId, String userId, boolean fetchAll, long attemptNumber) {
		...
		buffer.append(" where courseId = :courseId and scoId = :scoId and userId = :userId and attemptNumber = :attemptNumber ");

		List r = getHibernateTemplate().findByNamedParam(buffer.toString(), new String[]{"courseId", "scoId", "userId", "attemptNumber"}, new Object[] { courseId, scoId, userId, attemptNumber });
	...
	public IDataManager findByActivityId(long contentPackageId, String activityId, String userId, long attemptNumber) {
		...
		buffer.append("from ").append(SCODataManager.class.getName());
		buffer.append(" where contentPackageId = :contentPackageId and activityId = :activityId and userId = :userId and attemptNumber = :attemptNumber ");

		List r = getHibernateTemplate().findByNamedParam(buffer.toString(), new String[]{"contentPackageId", "activityId", "userId", "attemptNumber"}, new Object[] { contentPackageId, activityId, userId, attemptNumber });
