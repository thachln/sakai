...
public class ContentPackageResourceRequestTarget implements IRequestTarget {
	...
	public ContentPackageResourceRequestTarget(RequestParameters requestParameters) {
        if (log.isDebugEnabled()) {
            log.debug("BaoNQ.Debug.ContentPackageResourceRequestTarget in ContentPackageResouceReequestTarget");
        }
		this.requestParameters = requestParameters;
		log.debug("RequestParam path : "+requestParameters.getPath() + "  requestParamResourceKey"+requestParameters.getResourceKey());
		...
		log.debug("Resource Name : "+resName);
