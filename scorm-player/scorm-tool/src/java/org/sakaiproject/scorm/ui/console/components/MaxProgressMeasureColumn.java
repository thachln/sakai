...
public class MaxProgressMeasureColumn extends AbstractColumn implements ScormConstants {

	private static final long serialVersionUID = 1L;
	
	public MaxProgressMeasureColumn(IModel displayModel, String sortProperty) {
	...
	protected IModel createLabelModel(IModel embeddedModel)
	{
		...
		if (target instanceof LearnerExperience) {
			...
			value = experience.getMaxProgress();		
		} /*else if(target instanceof ActivitySummary) {
			ActivitySummary activity = (ActivitySummary)target;
			value = Utils.getPercentageString(activity.getProgressMeasure());
		}*/
