...
public class ProgressMeasureColumn extends AbstractColumn implements ScormConstants {

	private static final long serialVersionUID = 1L;
	
	public ProgressMeasureColumn(IModel displayModel, String sortProperty) {
