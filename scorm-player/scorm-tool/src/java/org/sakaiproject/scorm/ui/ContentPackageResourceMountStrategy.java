...
public class ContentPackageResourceMountStrategy extends AbstractRequestTargetUrlCodingStrategy {
	...
	public ContentPackageResourceMountStrategy(String mountPath) {
		super(mountPath);
		log.debug("ThachLN:mountPath=" + mountPath);
	}

	public IRequestTarget decode(RequestParameters requestParameters) {
        if (log.isDebugEnabled()) {
            log.debug("BaoNQ.Debug.decode in ContentPackageResourceMountStrategy");
            log.debug("path of request : " + requestParameters.getPath());
        }
