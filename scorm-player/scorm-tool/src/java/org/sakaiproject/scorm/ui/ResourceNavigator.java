...
public abstract class ResourceNavigator implements INavigable, Serializable {
	...
	public void displayResource(final SessionBean sessionBean, Object target) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("BaoNQ.Debug.displayResouce in ResourceNavigator");
        }
        ...
        if (log.isDebugEnabled()) {
            log.debug("BaoNQ.Debug.full URL: " + fullUrl);
        }
		if (useLocationRedirect()) {
			...
			if (target != null) {
                ...
                if (log.isDebugEnabled()) {
                    log.debug("BaoNQ.Debug.AjaxRequestTarget: addComponent & appendJavascript - initResizing()");
                }
			}
		} else if (target != null) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("BaoNQ.Debug.AjaxRequestTarget : appendJavascript - parent.scormContent.location.href="
                        + fullUrl + ";initResizing()");
            }
        }
