...
CALL mvn package sakai:deploy -nsu -o -Dmaven.tomcat.home=%TOMCAT_HOME% -Dmaven.test.skip=true
...
copy .\kernel\kernel-common\src\main\config\log4j.properties %TOMCAT_HOME%\sakai\
